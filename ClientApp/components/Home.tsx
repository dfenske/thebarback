    ...
    return (
      <div>
        <div className="background">
          <div className="layer">
            <div className="float-top snippet flow-text brown-text text-lighten-4">Not sure what to drink? Tell us what you're in the mood for and we'll booze you up right.</div>
            <div className="float-bottom"><a className="scroll-down-button" href="#content"><i className="large material-icons">keyboard_arrow_down</i></a></div>
          </div>
        </div>
        <div id="content">
          <ul>
